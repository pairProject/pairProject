...
public class CheckoutController implements CheckoutControllerLocal, CheckoutControllerRemote
{
    ...
    @Override
    public SaleTransactionEntity doCheckout(StaffEntity staffEntity) throws CreateNewSaleTransactionException
    {
        SaleTransactionEntity newSaleTransactionEntity = saleTransactionEntityControllerLocal.createNewSaleTransaction(new SaleTransactionEntity(totalLineItem, totalQuantity, totalAmount, new Date(), saleTransactionLineItemEntities, staffEntity, false));
        initialiseState();
